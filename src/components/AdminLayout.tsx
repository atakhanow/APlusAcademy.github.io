    ...
    () => [
      {
        ...
        items: [
          ...
          { title: 'Guruhlar', icon: LayoutDashboard, path: '/admin/groups', count: stats.groups },
          ...
          { title: "Ro'yxatdan o'tganlar", icon: FileText, path: '/admin/applications', count: stats.applications },
      ...
      },
      {
        ...
        items: [
          ...
          { title: 'Testimonials', icon: Quote, path: '/admin/testimonials', count: null },
        ],
      },
      {
        label: 'Moliya',
        items: [
          { title: 'Revenue', icon: Wallet, path: '/admin/finance/revenue', count: null },
          { title: 'Expenses', icon: CreditCard, path: '/admin/finance/expenses', count: null },
          { title: 'Teacher Salaries', icon: DollarSign, path: '/admin/finance/teacher-salaries', count: null },
        ],
      },
    ],
    [stats]
