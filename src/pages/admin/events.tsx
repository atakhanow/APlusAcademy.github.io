...
function EventsContent() {
  ...
  const [categories, setCategories] = useState<{ id: string; name_uz: string; name_ru: string; name_en: string }[]>([]);
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => {
                        const selected = categories.find((category) => category.name_uz === value);
                        setFormData({
                          ...formData,
                          category: selected?.name_uz || value,
                        });
                      }}
                      required
                    >
                      ...
                      <SelectContent>
                        {categories.length === 0 ? (
                          ...
                          categories.map((category) => (
                            <SelectItem key={category.id} value={category.name_uz || category.id}>
                              {category.name_uz || category.name || 'Kategoriya'}
                            </SelectItem>
                          ))
                        )}
                      </SelectContent>
