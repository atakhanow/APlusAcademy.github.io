...
import RevenuePage from "@/pages/admin/finance/revenue";
import ExpensesPage from "@/pages/admin/finance/expenses";
import TeacherSalaryPage from "@/pages/admin/finance/teacher-salaries";
  ...
  if (isAdminRoute) {
    return (
      <Switch>
        ...
        <Route path="/admin/finance/revenue" component={RevenuePage} />
        <Route path="/admin/finance/expenses" component={ExpensesPage} />
        <Route path="/admin/finance/teacher-salaries" component={TeacherSalaryPage} />
